<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="CirculoNegociosAdm.Account.Register" %>
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Use esta tela para criar um novo usuário adminsitrador.
                    </p>
                    <p>
                        A senha precisa ter pelo menos <%= Membership.MinRequiredPasswordLength %> caracteres.
                    </p>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="ConfirmPassword" CssClass="failureNotification" Display="Dynamic" 
                                     ErrorMessage="Confirmar a senha é obrigatorio." ID="ConfirmPasswordRequired" runat="server" 
                                     ToolTip="Confirmar a senha é obrigatorio." ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="PasswordCompare" runat="server" ControlToCompare="Password" ControlToValidate="ConfirmPassword" 
                                     CssClass="failureNotification" Display="Dynamic" ErrorMessage="As senhas digitadas não conferem."
