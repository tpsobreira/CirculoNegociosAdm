<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastroTipoPromocao.aspx.cs" Inherits="CirculoNegociosAdm.Pages.CadastroTipoPromocao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Cadastro de Tipo de Promoção
        <br />
        <br />
    </h2>
    <table>
    ...
    <table>
        <tr>
            <td>
                <asp:GridView ID="gdvTipoPromocao" runat="server" OnRowCommand="gdvTipoPromocao_RowCommand"
